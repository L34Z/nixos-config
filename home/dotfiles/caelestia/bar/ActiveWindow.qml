...
// Verbatim copy of upstream modules/bar/components/ActiveWindow.qml except
// for `colour` below (see home/z.nix, which installs this over the store
// copy). Re-sync against upstream when bumping the caelestia-shell input.
...
Item {
    ...
    // Upstream uses m3primary; onPrimary keeps the title readable against
    // the primary-coloured pills it sits between.
    property color colour: Colours.palette.m3onPrimary
